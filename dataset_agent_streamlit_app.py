...
# Get writable data directory (Docker: /app/data, Cloud: fallback to temp dir)
def get_data_dir():
...
def main():
    ...
    prompt = st.text_area(
        ...
        placeholder="Create a bar chart of species count",
        height=120
    )
    ...
    if st.button("Submit", type="primary", use_container_width=True):
        ...
        output_files = []
        try:
            # Run generated code with subprocess.run()
